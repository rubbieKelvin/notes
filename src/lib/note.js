...
import list_template from "@/templates/list.json";
import list_item_template from "@/templates/list_item.json";
...
export const Note = (_note) => {
  ...
  function addList() {
    ...
    _wrapper.value.content?.push(li);
    return li
  }

  function createListItem({ value, checked=false, can_check=false}){
    return {
      ...list_item_template,
      ...{value, checked, can_check},
      id: uuid4()
    }
  }
