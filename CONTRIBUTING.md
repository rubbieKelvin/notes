...
When you're done, submit a pull request to **notes/dev** branch and for one of the maintainers to check it out. We would let you know if there is any problem or any changes that should be considered.
