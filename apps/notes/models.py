...
class Note(models.Model):
    ...
    body = models.JSONField(default=_default_note_body)
    private = models.BooleanField(default=True)
    owner = models.ForeignKey('authr.User', on_delete=models.CASCADE)
    ...
    def upload(
        ...
        note.owner = User.objects.first()  # TODO: remove
        note.save()
        return note
...
class NoteShare(models.Model):
    note = models.ForeignKey('Note', on_delete=models.CASCADE)
    user = models.ForeignKey('authr.User', on_delete=models.CASCADE)
